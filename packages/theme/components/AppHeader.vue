...
import { useUiState } from '@vue-storefront/exedio-omnicommerce';
import { useCart, useUser, cartGetters } from '@vue-storefront/exedio-omnicommerce';
import { computed, ref, watch, onBeforeUnmount, useRouter } from '@nuxtjs/composition-api';
import { useUiHelpers } from '@vue-storefront/exedio-omnicommerce';
...
import RobotSearch from '~/components/RobotSearch.vue';
...
export default {
  ...
  setup(_, { root }) {
    ...
    const { toggleCartSidebar, toggleWishlistSidebar, toggleLoginModal, isMobileMenuOpen } =
      useUiState();
