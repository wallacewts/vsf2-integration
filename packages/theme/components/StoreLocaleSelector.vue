<template>
  <div class="container">
    ...
    >
        ...
        <SfListItem v-for="store in availableStores" :key="store.id">
          ...
          >
            <SfCharacteristic class="language">
              ...
              <template #icon>
                <SfImage
                  :src="`/icons/langs/${getStoreLocale(store)}.webp`"
                  width="20"
                  alt="Flag"
      ...
      <SfHeading :level="3" title="Choose language" class="container__lang--title" />
      <SfList>
...
import { useStore, useCart } from '@vue-storefront/exedio-omnicommerce';
