<template>
  <ValidationObserver v-slot="{ handleSubmit }">
    <form id="shipping-details-form" class="form" @submit.prevent="handleSubmit(submitForm)">
      ...
      <div class="form__horizontal">
        ...
        >
          <SfSelect
            ...
            :errorMessage="errors[0]"
          >
            <SfSelectOption v-for="{ name, label } in countries" :key="name" :value="name">
              {{ $t(label) }}
            </SfSelectOption>
          </SfSelect>
        </ValidationProvider>
      ...
      <div class="form__horizontal">
        <ValidationProvider name="state" :rules="validationRules.state" v-slot="{ errors }" slim>
          <SfSelect
            v-model="form.state"
      ...
      <ValidationProvider rules="required|phone" v-slot="{ errors }" class="form__element">
        <SfInput
          v-model="form.phone"
          name="phone"
