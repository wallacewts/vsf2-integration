<template>
  ...
  <SfBottomNavigation class="navigation-bottom smartphone-only">
    ...
    <SfBottomNavigationItem label="Basket" icon="add_to_cart" @click="toggleCartSidebar">
      <template #icon>
        <SfCircleIcon class="cart-button" aria-label="Add to cart">
          <SfIcon icon="add_to_cart" color="white" size="25px" :style="{ margin: '0 0 0 -2px' }" />
...
import { useUser, useCart, cartGetters } from '@vue-storefront/exedio-omnicommerce';
