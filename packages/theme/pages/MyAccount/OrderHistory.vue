        ...
        <SfTable class="products">
          ...
          <SfTableRow v-for="(item, i) in orderGetters.getItems(currentOrder)" :key="i">
            <SfTableData class="products__name">
              <nuxt-link
                :to="'/p/' + orderGetters.getItemSku(item) + '/' + orderGetters.getItemSku(item)"
              >
      ...
      <div v-else>
        ...
        <SfTable v-else class="orders">
          ...
          <SfTableRow v-for="order in orders" :key="orderGetters.getId(order)">
            ...
            <SfTableData v-e2e="'order-amount'">{{
...
<script>
import { SfTabs, SfTable, SfButton, SfProperty, SfLink, SfArrow } from '@storefront-ui/vue';
import { computed, ref } from '@nuxtjs/composition-api';
import { useUserOrder, orderGetters } from '@vue-storefront/exedio-omnicommerce';
