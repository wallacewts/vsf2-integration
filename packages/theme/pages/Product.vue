    ...
    <div class="product">
      ...
      <div class="product__info">
        ...
        <div>
          ...
          <div class="product__delivery" v-if="channels.length > 0">
            <SfRadio
          ...
          <div class="cep__calculation">
            <SfHeading
              :level="4"
              :title="'Simule o prazo e o valor do frete:'"
              class="filters__title sf-heading--left"
            />
            <SfInput
              @keyup="handleZipCode($event.target.value)"
              v-model="zipCode"
              v-e2e="'zipCode'"
              v-mask="'99999-999'"
              name="zipCode"
